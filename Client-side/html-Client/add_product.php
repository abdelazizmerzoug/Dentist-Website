...
<nav id="sidebar">
    <ul>
      ...
      <li>
        ...
        <ul class="sub-menu">
          <div>
            <li><a href="./add_product.php">Ajout un produit</a></li>
    ...
    <div class="form-container">
        <h1>Cabinet Stock</h1>
        <form action="../php-Client/add_product.php" id="productForm" method="POST" enctype="multipart/form-data">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="input-field">
                ...
                <input list="product_names" id="product_name" name="product_name" placeholder="Enter product name" required>
        ...
        <div class="input-field">
            ...
            <input type="number" step="0.01" id="unit_price" name="unit_price" placeholder="Enter price" required>
        </div>
        <!-- Total Cost -->
        <div class="input-field">
            <label for="total_cost">Total Cost:</label>
            <input type="number" step="0.01" id="total_cost" name="total_cost" placeholder="Enter total cost" required>
        </div>
        </div>           
        <!-- Quantity -->
        <div class="input-field">
        ...
        <div class="input-field">
            ...
            <select id="supplier" name="supplier_id" required>
                ...
                $query = "SELECT id_supplier, CONCAT(first_name, ' ', last_name) AS supplier_name FROM suppliers";
                $result = $conn->query($query);
                while ($row = $result->fetch_assoc()) {
                    echo "<option value='" . $row['id_supplier'] . "'>" . htmlspecialchars($row['supplier_name']) . "</option>";
                }
                $conn->close();
                ?>
            </select>
